...
export const INITIAL_SCHEDULE_EVENTS = [
  {
    ...
    priority: 'high',
    location: '각 교실 / 방송실',
    description: '2학기 개학식 및 학급 환경 정리',
    fromAi: false
  },
  {
    id: 'ev-02',
    ...
    fromAi: true,
    sourceMessageId: 'm-01'
  },
  {
    id: 'ev-03',
    title: '2-3반 전자칠판 유지보수 점검',
    date: '2026-08-28',
    time: '15:30',
    category: '업무',
    priority: 'medium',
    location: '2-3 교실',
    description: '융합정보부 오수빈 부장님 쪽지 연계 (에듀텍 방문)',
    fromAi: true,
    sourceMessageId: 'm-03'
  },
  {
    id: 'ev-04',
    title: '8월 특근매식비 K-에듀파인 품의 마감',
    date: '2026-08-28',
    time: '16:00',
    category: '공문마감',
    priority: 'high',
    location: '행정실',
    description: '행정실 변성민 실장님 공지',
    fromAi: true,
    sourceMessageId: 'm-04'
  },
  {
    id: 'ev-05',
    title: '방과후학교 온라인 수강신청 오픈',
    date: '2026-08-29',
    time: '09:00',
    category: '학사일정',
    priority: 'medium',
    location: '학교 홈페이지',
    description: '연구부 한지훈 부장님 공지 (8/29~8/31)',
    fromAi: true,
    sourceMessageId: 'm-02'
  },
  {
    id: 'ev-06',
    title: '점심시간 3층 복도 생활지도',
    ...
    priority: 'high',
    location: '3층 복도',
    description: '생활교육부 윤서아 부장님 배정 순번 (12:40~13:20)',
    fromAi: true,
    sourceMessageId: 'm-05'
  },
  {
    id: 'ev-07',
    title: '2학기 전체 교직원 회의',
    ...
    priority: 'urgent',
    location: '시청각실',
    description: '교장 이도현 선생님 소집 (2학기 학사운영 및 안전교육)',
    fromAi: true,
    sourceMessageId: 'm-06'
  },
  {
    id: 'ev-08',
    ...
    priority: 'urgent',
    location: '전교실',
    description: '2026학년도 2학기 1차 지필평가 (10/12 ~ 10/14)',
    fromAi: false
  }
];

export const INITIAL_TODOS = [
  { id: 'todo-01', text: '행정정보공유 사전동의서 학생 배부 및 수합', dueDate: '2026-08-27', completed: false, priority: 'high', linkedMessageId: 'm-01' },
  { id: 'todo-02', text: '2-3반 교실 게시판 2학기 시간표 부착', dueDate: '2026-08-28', completed: true, priority: 'medium' },
  { id: 'todo-03', text: '8월 특근매식비 지출품의서 작성 제출', dueDate: '2026-08-28', completed: false, priority: 'high', linkedMessageId: 'm-04' },
  { id: 'todo-04', text: '방과후학교 신청 안내 가정통신문 전달', dueDate: '2026-08-29', completed: false, priority: 'medium' },
